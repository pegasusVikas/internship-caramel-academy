...
def getts(number,b,c,id1,df):
    ...
    for i in range(number):
        ...
        # df=pd.read_json("C:/Users/DISHA/Desktop/Caramel IT Academy/Final/3.QB_Course_Completion_Assignment_Model/"+ "PYTS" +".json",encoding='latin1')
...
qlist=getts(no_of_ts,subcourse_code,difficulty,id1,ql)

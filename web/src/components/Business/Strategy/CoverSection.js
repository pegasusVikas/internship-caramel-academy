          ...
          <div className="w3-row">
            ...
            <div className="w3-col l8 s12">
              ...
              <div className="w3-card-4 w3-margin w3-white">
                <img src="../../images/Business-Operations.jpg" alt="Nature" style={{width: '100%'}} />
                <div className="w3-container">
                  <h3><b>Optimizing business &amp; operating models</b></h3>
                  <h5>Title Description, <span className="w3-opacity">Feb 10, 2020</span></h5>
                </div>
                <div className="w3-container">
                  <p>Does your operating model allow you to compete in the new? The right operating model can reinvigorate even the largest of legacy companies.</p>
                  <div className="w3-row">
              ...
              {/* Blog entry */}
              <div className="w3-card-4 w3-margin w3-white">
                <img src="../../images/business-purpose.jpg" alt="Norway" style={{width: '100%'}} />
                <div className="w3-container">
                  <h3><b>Building trust &amp; Purpose</b></h3>
                  <h5>Title Description, <span className="w3-opacity">Feb 10, 2020</span></h5>
                </div>
                <div className="w3-container">
                  <p>Breaking with traditional shareholders views of values and leading by engendering trust and purpose with employees, customers and society.</p>
                  <div className="w3-row">
                    <div className="w3-col m8 s12">
                      <p><button className="w3-button w3-padding-large w3-white w3-border"><b>READ MORE »</b></button></p>
                    </div>
            ...
            <div className="w3-col l4">
              ...
              <div className="w3-card w3-margin w3-margin-top">
                ...
                <div className="w3-container w3-white">
                  <h4><b>Stories</b></h4>
                  <p> One of the most important responsibilities that senior leaders and executives have is to make sure that all facets of their organization, including its processes, structures, behaviors, and competencies, are properly aligned with overall strategy. This course focuses on how you can successfully attain that alignment through culture and change.</p>
                </div>
              </div><hr />
              {/* Posts */}

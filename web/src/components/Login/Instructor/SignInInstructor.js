...
class SignInInstructor extends Component {
	...
	onSubmit(e) {
		...
		axios
			...
			//   this.state
			// )
			.post("/api/api/instructor-authenticate", this.state)
			.then((res) => {
				if (res.data.logged) {
		...
		return (
			<div>
									...
									<div className="card-body">
										...
										<form className="form-signin" onSubmit={this.onSubmit}>
											...
											<Link
												...
												to="/lms/instructor/forgot-password"
												style={{ fontSize: "20px" }}
											>
												Forgot password?
											</Link>
				...
				{this.state.islogged ? (
					<Redirect
						to={{
							pathname: "/lms/instructor/dashboard",

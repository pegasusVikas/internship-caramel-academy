      ...
      <div className="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div className="card card-signin my-5">
          <div className="card-body">
            <h2 className="card-title text-center"><b>Sign In As College / University</b></h2>
            <center>
        ...
        <button class="btn btn-lg btn-facebook btn-block text-uppercase" type="submit"><i class="fab fa-facebook-f mr-2"></i> Sign in with Facebook</button> */}
              <Link to="/lms/college/college_register" style={{fontSize: '20px'}}>Sign Up</Link><Link className="float-right" to="/lms/user/forgot-password" style={{fontSize: '20px'}}>Forgot password?</Link>
            </form>
          </div>
        </div>
      </div>

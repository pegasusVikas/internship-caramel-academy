...
const CoverSection2 = () => {
  ...
  <div className="container-fluid py-5">
    <div><h2 className="text-center font-weight-bold" style={{color: 'rgba(76,175,80,1)'}}>COMMUNICATION &amp; MEDIA BLOGS</h2></div>
  </div>
  <div className="container-fluid">
    <div className="row pb-5 mobile-disp">
      <div className="col-12 col-lg-3 col-md-3">
        <div className="w3-card w3-hover-shadow resp-margin">
          <img className="card-img image-card-indus" src="../../images/communication1.jpg" alt="Bologna" />
          <div className="card-img-overlay">
            <a href="#" className="btn btn-light btn-sm mt-1">Read More</a>
          </div>
          <div className="card-body">
            <h4 className="card-title">Communication &amp; Media</h4>
            <small className="text-muted cat">
              <i className="far fa-clock text-info" /> 30 minutes
              <i className="fas fa-users text-info" /> 4 portions
            </small>
            <p className="card-text">Messages can be targeted with a laser focus to very specific groups offering them relevant content.</p>
      ...
      <div className="col-12 col-lg-3 col-md-3">
        <div className="w3-card w3-hover-shadow  resp-margin">
          <img className="card-img image-card-indus img-fluid" src="../../images/communication2.jpg" alt="Bologna" />
          <div className="card-img-overlay">
            <a href="#" className="btn btn-light btn-sm mt-1">Read More</a>
          </div>
          <div className="card-body">
            <h4 className="card-title">Communiation &amp; Media</h4>
            <small className="text-muted cat">
              <i className="far fa-clock text-info" /> 30 minutes
              <i className="fas fa-users text-info" /> 4 portions
            </small>
      ...
      <div className="col-12 col-lg-3 col-md-3">
        <div className="w3-card w3-hover-shadow  resp-margin">
          <img className="card-img image-card-indus img-fluid" src="../../images/communication3.jpg" alt="Bologna" />
          <div className="card-img-overlay">
            <a href="#" className="btn btn-light btn-sm mt-1">Read More</a>
          </div>
          <div className="card-body">
      ...
      <div className="col-12 col-lg-3 col-md-3">
        <div className="w3-card w3-hover-shadow  resp-margin">
          <img className="card-img image-card-indus" src="../../images/communication4.jpg" alt="Bologna" />
          <div className="card-img-overlay">
            <a href="#" className="btn btn-light btn-sm mt-1">Read More</a>
          </div>
          <div className="card-body">
    ...
    <div className="carousel-flick" data-flickity="{ &quot;wrapAround&quot;: true }">
      <div className="carousel-cell-cons"> 
        <div className="card  resp-margin">
          <img className="card-img image-card-indus" src="../../images/communication3.jpg" alt="Bologna" />
          <div className="card-img-overlay">
            <a href="#" className="btn btn-light btn-sm mt-1">Read more</a>
          </div>
          <div className="card-body">
      ...
      <div className="carousel-cell-cons"> 
        <div className="card resp-margin">
          <img className="card-img image-card-indus" src="../../images/communication4.jpg" alt="Bologna" />
          <div className="card-img-overlay">
            {/* <a href="#" class="btn btn-light btn-sm">Automotive</a> 
          </div>
          <div className="card-body">
            <h4 className="card-title">Communiation &amp; Media</h4>
            <small className="text-muted cat">
      ...
      <div className="carousel-cell-cons">
        <div className="card resp-margin">
          <img className="card-img image-card-indus" src="../../images/communication2.jpg" alt="Bologna" />
          <div className="card-img-overlay">
            <a href="#" className="btn btn-light btn-sm mt-1">Read more</a>
          </div>
          <div className="card-body">
